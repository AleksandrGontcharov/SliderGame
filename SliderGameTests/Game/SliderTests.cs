...
namespace SliderGame.Game.Tests
{
    public class SliderTests
    {
        ...
        public void SliderTest()
        {
            ...
            Assert.True((sliderNotValid2.currPosition == 0 && sliderNotValid2.direction == true), "sliderNotValid2 unexepected result");
            ...
            Assert.True((sliderNotValid4.currPosition == 0 && sliderNotValid4.direction == true), "sliderNotValid4 unexepected result");

            var sliderNotValid5 = new Slider(5);
            Assert.True((sliderNotValid5.currPosition <= 5 && sliderNotValid5.currPosition >= 0), "sliderNotValid5 unexepected result");
        }
